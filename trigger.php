 ...
 * 
 * Esta aplicação será uma CDN que, no geral, significa uma rede de distribuição de conteúdo e envolve procedimentos de redes de computadore e muitos servidores. Mas, aqui, somente será aplicado o conceito genérico e resumido de CDN: ponto de distribuição de conteúdo.
 * 
